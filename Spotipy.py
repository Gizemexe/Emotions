...
def get_emotion_recommendations(emotion_id):
    ...
    if results['playlists']['items']:
        ...
        for playlist in valid_playlists:
            ...
            all_track_ids.extend(track_ids)  # Collecting all songs
        ...
        # Get song features
        track_list = []
        for track_id in all_track_ids[:10]:  # Take the first 10 songs
